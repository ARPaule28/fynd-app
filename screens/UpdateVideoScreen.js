...
export default function UpdateVideoScreen({ route }) {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      if (response.data) {
        Alert.alert('Upload Successful', 'Your video has been updated successfully!');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.subtitle}>UPDATE HIGHLIGHT VIDEO</Text>
