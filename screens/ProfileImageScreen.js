...
export default function ProfileImageScreen() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://192.168.1.8:3000/students/upload-profile-image', formData, {
        headers: {
      ...
      if (response.data) {
        Alert.alert('Upload Successful', 'Your profile image has been uploaded successfully!');
